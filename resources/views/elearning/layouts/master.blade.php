    ...
    <div class="container-scroller">
        ...
        <nav id="top-nav" class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div id="logoweb" class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center"
                data-intro="Selamat datang di website E-learning GSM, Yuk kita tur dulu!" data-position="bottom">
        ...
        <div class="container-fluid page-body-wrapper" style="z-index:auto;">
            ...
            <nav style="z-index:1000;" class="sidebar sidebar-offcanvas" id="sidebar"
                data-intro="Menu berupa kumpulan kegiatan yang bisa user lakukan ~" data-position="right">
                <ul class="nav">
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/elearning/berita-gsm">Berita
                                        GSM</a></li>
                                <li class="nav-item"><a class="nav-link"
                                        href="/elearning/persebaran-gsm">Persebaran GSM</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link"
                                        href="/elearning/rincian-profil">Rincian Profil</a></li>
                                <li class="nav-item"><a class="nav-link" href="/elearning/ubah-profil">Ubah
                                        Profil</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link"
                                        href="/elearning/materi/materi-special">Materi Special</a></li>
                                <li class="nav-item"><a class="nav-link"
                                        href="/elearning/materi/materi-basic">Level Basic</a></li>
                                <li class="nav-item"><a class="nav-link"
                                        href="/elearning/materi/materi-advanced">Level Advanced</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="charts">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ url('/elearning/berbagi/buat-konten-berbagi') }}">Buat Konten
                                        Berbagi</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ url('/elearning/berbagi/lini-masa-berbagi') }}">Lini Masa
                                        Berbagi</a>
                                </li>
                            </ul>
                        </div>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 from
