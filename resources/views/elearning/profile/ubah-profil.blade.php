            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card position-relative">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <form action="{{ route('ubahdata') }}" method="POST" enctype="multipart/form-data"
                                    id="ubahDiri">
                                    @csrf
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <div id="the-basics">
                                                    <input class="typeahead" type="text" placeholder="Isikan disini..."
                                                        name="name" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="card-body d-flex justify-content-center">
                                        @if (Auth::user()->avatar)
                                            <img class="image rounded-circle"
                                                ...
                                                style="width: 150px;height: 150	px; padding: 10px; margin: 0px; ">
                                        @endif
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <form action="{{ route('updatePhoto') }}" method="POST"
                                                enctype="multipart/form-data" style="padding-top:20px;">
                                                @csrf
