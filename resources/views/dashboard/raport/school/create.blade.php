            ...
            <div class="card">
                ...
                <form class="forms-sample" method="POST" action="/raport/raportsekolah/newraportsekolah">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Sekolah">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_modul" id="nama_modul" class="form-control" placeholder="Masukkan Nama Modul">
                    </div>
                    <div class="form-group">
                        <label for="nilai_modul">Nilai Modul</label>
                        <input type="text" name="nilai_modul" id="nilai_modul" class="form-control" placeholder="Masukkan Nilai Modul">
                    </div>
